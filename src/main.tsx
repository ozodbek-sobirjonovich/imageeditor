  ...
  ui: {
    ...
    nav: {
      items: [
        {
          name: 'stamp',
          icon: Pixie.defaultConfig.ui!.nav!.items!.find(
            i => i.name === 'frame'
          )!.icon,
          action: async function () {
            // pixie.tools.resize.apply({ width: 1080, height: 1080 });
            //pixie.tools.filter.apply('grayscale');
            // await (window as any).pixie.tools.import.addImageFromUrl(
